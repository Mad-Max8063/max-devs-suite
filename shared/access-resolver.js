// ============================================
// shared/access-resolver.js — 4-Tier Access Priority Resolution
// ============================================
// Single source of truth for premium/access evaluation.
// Handles snake_case (DB), camelCase (card engine), PascalCase (turnos Profile).

export function resolveAccessPriority(userObject) {
    const now = new Date();
