-- ============================================
-- Migration: Add p_whatsapp_catalog_url to update_business_profile_secure RPC
-- 2026-05-03
-- ============================================
...
REVOKE ALL ON FUNCTION public.update_business_profile_secure(
    UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, BOOLEAN, NUMERIC
) FROM PUBLIC;
