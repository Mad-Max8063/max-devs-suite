...
export const BUSINESS_CATEGORIES: BusinessCategory[] = [
    // ── CORE (Top 5 by demand) ──────────────────
    {
        ...
        searchTags: ['peluquería', 'pelo', 'cabello', 'corte', 'color', 'brushing', 'mechas', 'peinado'],
    ...
    },
    {
        ...
        group: 'Belleza y Bienestar',
        icon: 'content_cut',
        searchTags: ['barbería', 'barbero', 'corte', 'barba', 'afeitado', 'caballero'],
        nombre: 'Barbería',
        emoji: '💈',
    ...
    {
        id: 'unas',
        label: 'Manicuría y Uñas',
        group: 'Belleza y Bienestar',
        icon: 'pan_tool',
        searchTags: ['uñas', 'manicuría', 'pedicuría', 'semipermanente', 'esculpidas', 'poligel'],
    ...
    },
    {
        ...
        group: 'Belleza y Bienestar',
        icon: 'visibility',
        searchTags: ['cejas', 'pestañas', 'lifting', 'laminado', 'henna', 'extensiones'],
    ...
    },
    {
        ...
        group: 'Belleza y Bienestar',
        icon: 'auto_fix_high',
        searchTags: ['depilación', 'cera', 'láser', 'bozo', 'rostro', 'piernas'],
        nombre: 'Depilación',
        emoji: '✨',
    ...
    // ── SECONDARY ───────────────────────────────
    {
        ...
        group: 'Belleza y Bienestar',
        icon: 'spa',
        searchTags: ['estética', 'facial', 'limpieza', 'peeling', 'antiage', 'dermapen'],
    ...
    },
    {
        ...
        searchTags: ['masajes', 'bienestar', 'relajante', 'descontracturante', 'drenaje', 'reflexología'],
    ...
    // ── PERSONALIZADO ───────────────────────────
    {
        ...
        group: 'Belleza y Bienestar',
        icon: 'draw',
        searchTags: ['tatuaje', 'tattoo', 'piercing', 'ink', 'perforación'],
        descripcion: 'Tatuajes, piercing y sesiones de diseño',
        servicios: [],
    },
    {
        id: 'medicina-general',
        ...
        icon: 'stethoscope',
        searchTags: ['médico', 'doctor', 'clínico', 'consulta', 'salud'],
        descripcion: 'Consultas médicas generales y controles',
        servicios: [],
    },
    {
        id: 'odontologia',
        ...
        group: 'Salud y Medicina',
        icon: 'dentistry',
        searchTags: ['dentista', 'odontólogo', 'dientes', 'ortodoncia', 'muela'],
        descripcion: 'Turnos odontológicos y tratamientos dentales',
        servicios: [],
    },
    {
        id: 'psicologia',
        ...
        group: 'Salud y Medicina',
        icon: 'psychology',
        searchTags: ['psicólogo', 'terapia', 'salud mental', 'consulta'],
        descripcion: 'Sesiones de terapia y acompañamiento profesional',
        servicios: [],
    },
    {
        id: 'nutricion',
        ...
        searchTags: ['nutricionista', 'dieta', 'alimentación', 'salud'],
    ...
    },
    {
        ...
        searchTags: ['kinesiólogo', 'rehabilitación', 'lesión', 'fisioterapia'],
        descripcion: 'Rehabilitación, fisioterapia y recuperación funcional',
        servicios: [],
    },
    {
        id: 'abogado',
        ...
        icon: 'gavel',
        searchTags: ['abogado', 'leyes', 'legal', 'jurídico', 'estudio'],
        descripcion: 'Consultas legales y asesoramiento jurídico',
        servicios: [],
    },
    {
        id: 'contador',
        ...
        descripcion: 'Asesoría contable, fiscal e impositiva',
        servicios: [],
    },
    {
        id: 'consultoria',
        ...
        group: 'Servicios Profesionales',
        icon: 'support_agent',
        searchTags: ['consultor', 'asesoría', 'negocios', 'b2b', 'estrategia'],
        descripcion: 'Consultoría profesional y sesiones de asesoría',
        servicios: [],
    },
    {
        id: 'coaching',
        ...
        searchTags: ['coach', 'mentoría', 'liderazgo', 'desarrollo'],
    ...
    },
    {
        ...
        group: 'Educación',
        icon: 'school',
        searchTags: ['profesor', 'clases', 'apoyo', 'inglés', 'matemática'],
        descripcion: 'Clases, cursos y acompañamiento educativo',
        servicios: [],
    },
    {
        id: 'clases-musica',
        ...
        group: 'Educación',
        icon: 'music_note',
        searchTags: ['música', 'guitarra', 'piano', 'canto', 'instrumento'],
        descripcion: 'Clases de instrumentos, canto y teoría musical',
        servicios: [],
    },
    {
        id: 'taller-mecanico',
        ...
        group: 'Hogar y Vehículos',
        icon: 'handyman',
        searchTags: ['auto', 'mecánico', 'taller', 'motor', 'service'],
        descripcion: 'Servicios mecánicos y mantenimiento vehicular',
        servicios: [],
    },
    {
        id: 'car-detailing',
